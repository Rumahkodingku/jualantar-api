...
use App\Modules\Merchant\Http\Requests\IndexMerchantRequest;
...
class MerchantController extends Controller
{
    ...
    public function show(Merchant $merchant): JsonResponse
    {
        ...
        $merchant->setAttribute('reviewer', $merchant->reviewed_by === null ? null : ($users[$merchant->reviewed_by] ?? null));
