...
return [
    ...
    'info' => [
         ...
         * API version.
         */
        'version' => env('API_VERSION', config('api.version')),

        /*
         * Description rendered on the home page of the API documentation (`/docs/api`).
         */
        'description' => 'JualAntar API. Responses use a `{ "data": ... }` envelope, with `meta` added on paginated endpoints. Errors follow RFC 9457 problem details (`application/problem+json`).',
    ],

    'ui' => [
        'title' => env('API_DOCS_TITLE', 'JualAntar API'),
    ],
