...
return [
    ...
    */
    ...
    'codes' => [
        ...
        'catalog_category_in_use' => ['status' => 409, 'title' => 'Conflict'],
        'variable_product_requires_active_variant' => ['status' => 409, 'title' => 'Conflict'],
        'last_active_variant' => ['status' => 409, 'title' => 'Conflict'],
        'media_limit_reached' => ['status' => 409, 'title' => 'Conflict'],
        'variant_not_allowed_for_simple_product' => ['status' => 422, 'title' => 'Unprocessable Entity'],
        'modifier_group_limit_reached' => ['status' => 409, 'title' => 'Conflict'],
        'modifier_limit_reached' => ['status' => 409, 'title' => 'Conflict'],
        'modifier_group_insufficient_modifiers' => ['status' => 409, 'title' => 'Conflict'],
        'modifier_required_by_active_group' => ['status' => 409, 'title' => 'Conflict'],
        'product_draft_not_found' => ['status' => 404, 'title' => 'Not Found'],
        'product_draft_version_conflict' => ['status' => 409, 'title' => 'Conflict'],
        'product_draft_invalid' => ['status' => 422, 'title' => 'Unprocessable Entity'],
